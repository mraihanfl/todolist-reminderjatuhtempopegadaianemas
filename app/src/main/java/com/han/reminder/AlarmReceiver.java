...
public class AlarmReceiver extends BroadcastReceiver {
    public static final String TYPE_ONE_TIME = "Jatuh Tempo Nasabah";
    public static final String TYPE_REPEATING = "RepeatingAlarm";
    public static final String EXTRA_MESSAGE = "message";
    public static final String EXTRA_TYPE = "type";

    private static final int ID_ONETIME = (int) System.currentTimeMillis();
    ...
    private void showAlarmNotification(Context context, String title, String message, int notifId) {
        ...
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(context, CHANNEL_ID)
                .setSmallIcon(R.drawable.gambar_time)
    ...
    public void  setOneTimeAlarm(Context context, String type, String date, String time, String message) {
        ...
        calendarJT.set(Calendar.YEAR, Integer.parseInt(dateArray[0]));
        calendarJT.set(Calendar.MONTH, Integer.parseInt(dateArray[1]) - 1);
        calendarJT.set(Calendar.DAY_OF_MONTH, Integer.parseInt(dateArray[2]));
        calendarJT.set(Calendar.HOUR_OF_DAY, Integer.parseInt(timeArray[0]));
        calendarJT.set(Calendar.MINUTE, Integer.parseInt(timeArray[1]));
        calendarJT.set(Calendar.SECOND, 0);



        PendingIntent pendingIntent = PendingIntent.getBroadcast(context, requestCode, intent, PendingIntent.FLAG_MUTABLE);
        if (alarmManager != null) {
            alarmManager.set(AlarmManager.RTC_WAKEUP, calendarJT.getTimeInMillis(), pendingIntent);
        }

        Toast.makeText(context, "Notifikasi is set", Toast.LENGTH_SHORT).show();
    }
